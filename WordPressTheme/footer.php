                ...
                <div class="contact-box__right">
                    <div class="contact-box__heading">
                        <div class="section-heading">
                            ...
                            <h2 class="section-heading__japaneseTitle section-heading__japaneseTitle-contact">お問い合わせ</h2>
                        </div>
                        <p class="contact-box__text">ご注文・お問い合わせはコチラ</p>
                    </div>
                ...
                <div class="footer__head">
                    ...
                    <div class="footer__sns">
                        <a href="https://www.facebook.com" class="footer__sns-icon" target="_blank">
                            <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/sns-facebook_icon.svg" alt="フェイスブックはこちらをクリック"/>
                        </a>
                        <a href="https://www.instagram.com" class="footer__sns-icon" target="_blank">
                            <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/sns-instagram_icon.svg" alt="インスタグラムはこちらをクリック"/>
                        </a>
                    </div>
                </div>
