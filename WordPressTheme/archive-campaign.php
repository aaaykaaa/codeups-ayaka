...
<div class="page-mv sub-page-mv">
    <div class="page-mv__inner">
        ...
        <picture class="page-mv__img">
            ...
            <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/pageMv-sp4.jpg" alt="キャンペーンページのメイン画像"/>
        </picture>
    </div>
</div>
                    ...
                    <div class="campaign-card__inner">
                        ...
                        <div class="campaign-card__body campaign-card__body--page">
                            ...
                            <div class="campaign-card__prices campaign-card__prices--page">
                                <p class="campaign-card__price-cost"><?php echo isset($campaignPrices['price-cost']) && is_numeric($campaignPrices['price-cost']) ? "&yen;" . number_format((float)$campaignPrices['price-cost']) : ''; ?></p>
                                <p class="campaign-card__price-low"><?php echo isset($campaignPrices['price-low']) && is_numeric($campaignPrices['price-low']) ? "&yen;" . number_format((float)$campaignPrices['price-low']) : ''; ?></p>
                            </div>
