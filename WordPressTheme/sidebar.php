    ...
    <div class="aside__inner">
            ...
            <div class="aside-blog-ranking__blog-cards blog-cards blog-cards--1col">
                <a href="#" class="blog-cards__item blog-card">
                    <div class="blog-card__wrapper">
                        ...
                        <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/blog4.jpeg" alt="ブログ4"/>
                        </figure>
                        <div class="blog-card__body">
                            <time class="blog-card__date blog-card__date--ranking" datetime="2023-11-27">2023/11/17</time>
                            <h3 class="blog-card__title blog-card__title--ranking">ライセンス取得</h3>
                        </div>
                    </div>
                </a>
                <a href="#" class="blog-cards__item blog-card">
                    <div class="blog-card__wrapper">
                        <figure class="blog-card__img blog-card__img--ranking">
                            <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/blog2.jpeg" alt="ブログ2"/>
                        </figure>
                        <div class="blog-card__body">
                            <time class="blog-card__date blog-card__date--ranking" datetime="2023-11-27">2023/11/17</time>
                            <h3 class="blog-card__title blog-card__title--ranking">ウミガメと泳ぐ</h3>
                        </div>
                    </div>
                </a>
                <a href="#" class="blog-cards__item blog-card">
                    <div class="blog-card__wrapper">
                        <figure class="blog-card__img blog-card__img--ranking">
                            <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/blog3.jpeg" alt="ブログ3"/>
                        </figure>
                        <div class="blog-card__body">
                            <time class="blog-card__date blog-card__date--ranking" datetime="2023-11-27">2023/11/17</time>
                            <h3 class="blog-card__title blog-card__title--ranking">カクレクマノミ</h3>
                        </div>
                    </div>
                </a>
            </div>
        ...
        <section class="aside-campaign">
            ...
            <div class="aside-campaign__cards campaign-cards">
                ...
                <div class="campaign-cards__card campaign-card">
                    <figure class="campaign-card__img campaign-card__img--aside">
                        <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/campaign2.jpg" alt="キャンペーン2"/>
                    </figure>
                    <div class="campaign-card__body campaign-card__body--aside">
            ...
            <div class="aside-campaign__btn">
                <a href="./page-campaign.html" class="button"><span>View more</span></a>
            </div>
        </section>
